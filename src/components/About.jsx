export default function About ()
{
    return (
        <div className="xl:min-h-screen w-full pt-20 md:flex md:justify-center relative">
            <div id="shadow-about" className="w-full h-64.5 absolute bottom-0 md:bottom-4 lg:bottom-12 lg:h-150 z-1"></div>
            <div id="about-container" className="p-4 m-4 w-full md:w-[90%] xl:w-[80%] grid grid-cols-[398px] md:grid-cols-[749px] xl:grid-cols-[1247px] xl:items-center xl:gap-x-22 xl:pt-8 justify-center pt-16 gap-y-12 overflow-y-clip">
