...
import { aboutText, aboutImage } from "../lib/animations/aboutReveal.js";
import Container from "../lib/Container.jsx";

export default function About ()
{
    return (
        <div id="about-me-section" className="relative pt-20 xl:min-h-screen md:pt-36 md:pb-26">
            <div id="shadow-about" className="w-full h-64.5 absolute -bottom-1 md:bottom-24 lg:h-150 z-1"></div>
            <Container id="about-container" className="relative pt-16">
                <div className="grid gap-y-12 xl:grid-cols-2 xl:items-center xl:gap-x-20">
                    <motion.div {...aboutText} className="md:text-center xl:text-start xl:z-2">
                        ...
                        <p className="text-[1.25rem] md:text-[1.5rem] mb-8 xl:mb-12">
                        ...
                        <div id="button-cv" className="cursor-pointer bg-(--body-color) text-(--title-color) py-4 px-8 rounded-[4rem] font-unbounded inline-flex items-center gap-x-2">
                            <a className="text-[1.25rem] md:text-[1.5rem] transition duration-400 ease-in-out" href="/pdf/supawithCV.pdf" download target="_blank">Resume</a>
                    ...
                    <motion.div {...aboutImage} className="relative justify-self-center xl:-order-1">
