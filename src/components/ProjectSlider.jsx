                ...
                <SwiperSlide key={project.id} className="w-full md:!w-[450px] lg:!w-[550px]">
                    <article className="relative bg-(--container-color) p-6 rounded-[3rem] overflow-hidden px-4 md:p-8 lg:p-10 lg:rounded-[4rem]">
                        ...
                        <div className="relative z-10 my-8">
                            <h1 className="text-[1.75rem] md:text-[2.25rem] lg:text-[2.75rem] xl:text-[3rem] mb-4">{project.title}</h1>
                            <p className="font-unbounded text-[1.25rem] md:text-[1.5rem] lg:text-[1.75rem] mb-2">Technologies used</p>
                            <p className="text-[1.25rem] md:text-[1.5rem] lg:text-[1.75rem]">{project.tech.join(", ")}</p>
                        </div>
