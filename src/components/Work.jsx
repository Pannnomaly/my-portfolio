...
import { workTitleReveal, workToggleReveal, workContentReveal } from "@/lib/animations/workReveal.js";
...
export default function Work ()
{
    ...
    return (
        <div className="pt-20 xl:min-h-screen md:pt-36 md:pb-16">
            <Container>
                <motion.h2 {...workTitleReveal} className="text-center text-[2rem] md:text-[2.5rem] lg:text-[3rem] xl:text-[3.25rem]">
                    <span className="text-(--first-color)">My Work</span>
                    <br /> Experience
                </motion.h2>

                <div>
                    <motion.div {...workToggleReveal} className="bg-(--container-color) mt-16 mb-10 lg:mt-20 lg:mb-14 xl:mt-22 xl:mb-18 py-5 px-8 rounded-[4rem] flex justify-between md:justify-self-center md:gap-x-25">
                        <ToggleButton
                        onClick={() => {
                            setView("experience");
                        }}
                    ...
                    <motion.div {...workContentReveal} className="relative pl-6 lg:pl-0">
