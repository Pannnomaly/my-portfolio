    ...
    return (
        <div className="xl:min-h-screen w-full pt-20 relative md:flex md:justify-center">
            ...
            <div className="p-4 m-4 w-full md:w-[90%] xl:w-[80%] relative pt-16 gap-y-12">
                ...
                <div id="cv" className="absolute z-2 right-0 bottom-6 md:-bottom-4 -rotate-90 xl:rotate-0 xl:right-0 xl:bottom-22 text-light hover:text-(--first-color) font-unbounded flex items-center gap-x-2 transition duration-400 ease-in-out cursor-pointer">
