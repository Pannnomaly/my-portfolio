...
export default function Hero ()
{
    ...
    return (
        <div className="lg:min-h-screen w-full pt-20 relative md:flex md:justify-center">
            ...
            <div className="p-4 m-4 w-full md:w-[90%] lg:w-[80%] relative pt-16 gap-y-12">
                <div className="lg:absolute lg:top-72 lg:left-12 lg:z-2">
                ...
                <div className="relative grid overflow-y-clip">
                    ...
                    <div className="flex justify-center mt-12">
                        <img className="w-70 md:w-90 lg:w-150 self-center" src="profile.PNG" alt="profile picture" />
                    </div>
                </div>
                <div className="absolute z-2 -bottom-10 md:-bottom-22  justify-self-center lg:top-72 lg:right-4">
                ...
                <div className="absolute z-2 top-70 self-center flex flex-col gap-y-3 lg:-bottom-86 lg:gap-y-6">
                    ...
                    <a id="social" href="https://www.fiverr.com/pannnomaly/" target="_blank">
                ...
                <div id="cv" className="absolute z-2 right-0 bottom-6 md:-bottom-4 -rotate-90 lg:rotate-0 lg:right-0 lg:bottom-22 text-light hover:text-(--first-color) font-unbounded flex items-center gap-x-2 transition duration-400 ease-in-out cursor-pointer">
